...
const App: React.FC = () => {
  ...
  return (
    // Usamos 100dvh para que en móviles no se “corte” por las barras del navegador
    <div
      className="flex flex-col bg-[#f9f9f9] font-sans text-gray-800"
      style={{ height: '100dvh' }}
    >
      <Header />

      {/* Chat Area */}
      {/* Dejamos espacio por header fijo y por footer fijo */}
      <main className="flex-1 overflow-y-auto p-4 sm:p-6 pt-20 sm:pt-24 pb-[104px] sm:pb-[120px] max-w-3xl mx-auto w-full">
      ...
      {/* Input Area (footer fijo con altura definida) */}
      <footer className="fixed bottom-0 left-0 w-full bg-white border-t border-gray-200 z-40 h-[88px] sm:h-[100px]">
        <div className="h-full max-w-3xl mx-auto flex flex-col justify-center gap-1 sm:gap-2 px-3 sm:px-4">
          ...
          <div className="text-center">
            <p className="text-[10px] text-gray-400">
              Patio Funes © {new Date().getFullYear()}
            </p>
          </div>
        </div>
      </footer>
